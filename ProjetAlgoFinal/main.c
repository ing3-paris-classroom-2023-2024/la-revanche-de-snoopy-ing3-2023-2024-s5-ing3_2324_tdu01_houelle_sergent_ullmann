...
void TimerScore(time_t startTime, int* score) {
    ...
    switch (a) {
        ...
        case 2:
            ...
            while (difftime(time(NULL), startTime) < durée) {
                TimerScore(startTime, &score);
                if (lectureFichier("C:\\Users\\Nicolas\\Desktop\\plateau.txt") < 0) return 0;
                    ...
                    for (i = 0; i < 6000; i++) {
                        if (_kbhit() != 0) {
                            ...
                            if (nbOiseau == 0) {
                                afficheSnoopyWins();
                                Sleep(5000);
                                if (lectureFichier("C:\\Users\\Nicolas\\Desktop\\plateau2.txt") < 0) return 0;
                                constructionPlateau();
                                nbOiseau = 4;
            ...
            switch (b) {
                ...
                case 1:
                    ...
                    if (verifmdp(motdepasse[0])) {
                        ...
                        while (difftime(time(NULL), startTime) < durée) {
                            TimerScore(startTime, &score);
                            if (lectureFichier("C:\\Users\\Nicolas\\Desktop\\plateau3.txt") < 0) return 0;
                            //    if(lectureFichier("plateau.txt")<0) return 0;
                            constructionPlateau();
                            fin = 0;
                            nbOiseau = 4;
                                ...
                                for (i = 0; i < 6000; i++) {
                                    if (_kbhit() != 0) {
                                        ...
                                        if (nbOiseau == 0) {
                                            ...
                                            Sleep(5000);
                                            if (lectureFichier(
                                                    "C:\\Users\\thoma\\CLionProjects\\ProjetAlgo\\plateau2.txt") < 0)
                                                return 0;
                                            constructionPlateau();
                                            nbOiseau = 4;
                                            nbVie = 3;
                        ...
                        if (verifmdp(motdepasse[1])) {
                            ...
                            while (difftime(time(NULL), startTime) < durée) {
                                TimerScore(startTime, &score);
                                if (lectureFichier("C:\\Users\\thoma\\CLionProjects\\ProjetAlgo\\plateau2.txt") < 0)
                                    return 0;
                                //    if(lectureFichier("plateau.txt")<0) return 0;
                                constructionPlateau();
                                fin = 0;
                                    ...
                                    for (i = 0; i < 6000; i++) {
                                        if (_kbhit() != 0) {
                                            ...
                                            if (nbOiseau == 0) {
                                                ...
                                                Sleep(5000);
                                                if (lectureFichier(
                                                        "C:\\Users\\thoma\\CLionProjects\\ProjetAlgo\\plateau3.txt") <
                                                    0)
                                                    return 0;
                                                constructionPlateau();
                                                nbOiseau = 4;
                            ...
                            if (verifmdp(motdepasse[2])) {
                                ...
                                while (difftime(time(NULL), startTime) < durée) {
                                    TimerScore(startTime, &score);
                                    if (lectureFichier("C:\\Users\\thoma\\CLionProjects\\ProjetAlgo\\plateau3.txt") <
                                        0)
                                        return 0;
                                    constructionPlateau();
                                    fin = 0;
